export function publicBlogPage(): string {
  const posts = [
    {
      title: "Welcome to Quill",
      slug: "welcome-to-quill",
      excerpt: "A simple introduction to the Quill blogging platform.",
      date: "September 2, 2026",
    },
    {
      title: "Building with MCP",
      slug: "building-with-mcp",
      excerpt: "Learn how Quill uses the Model Context Protocol.",
      date: "September 2, 2026",
    },
  ];
  ...
  return `
    ...
    <html lang="en">
      ...
      <body>
        <header class="header">
          <div class="header-content">
            <a href="/blog">← Back to Quill Blog</a>
          </div>
        </header>
